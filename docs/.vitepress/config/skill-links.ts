const skills = [
  {
    ...
    items: [
      ...
      {
        text: "使用代码片段重写表格列",
        link: "/技巧/beeboat/01使用代码片段重写表格列",
      },
      {
        text: "使用代码片段实现动态列",
        link: "/技巧/beeboat/02使用代码片段实现动态列",
      },
      {
        text: "使用代码片段实现表头合并",
        link: "/技巧/beeboat/03使用代码片段实现表头合并",
      },
      {
        text: "重写组件事件/属性",
        link: "/技巧/beeboat/04重写组件事件",
      },
      {
        text: "重写组件事件使用emit",
        link: "/技巧/beeboat/05重写组件事件使用emit",
      },
      {
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: "表单多个下拉级联的逻辑事件",
            link: "/技巧/使用说明/08表单多个下拉级联的逻辑事件",
          },
          {
            text: "表单form-item中多个表单元素",
            link: "/技巧/使用说明/15form-item组件",
          },
          {
            text: "弹窗组件中使用自定义组件",
            link: "/技巧/使用说明/09弹窗组件中使用自定义组件",
          },
          {
            text: "表格行内编辑",
            link: "/技巧/使用说明/11行内编辑功能使用",
          },
          {
            text: "表格批量删除&变量进阶",
            link: "/技巧/使用说明/13变量进阶使用",
          },
        ],
      },
    ],
