import{_ as s,o as a,c as n,Q as l}from"./chunks/framework.4310c879.js";const g=JSON.parse('{"title":"Pagination分页器显示英文","description":"","frontmatter":{},"headers":[],"relativePath":"bugs/elementplus/question/1.md","filePath":"bugs/elementplus/question/1.md"}'),e={name:"bugs/elementplus/question/1.md"},o=l(`<h1 id="pagination分页器显示英文" tabindex="-1">Pagination分页器显示英文 <a class="header-anchor" href="#pagination分页器显示英文" aria-label="Permalink to &quot;Pagination分页器显示英文&quot;">​</a></h1><h2 id="产生原因" tabindex="-1">产生原因 <a class="header-anchor" href="#产生原因" aria-label="Permalink to &quot;产生原因&quot;">​</a></h2><p>没有设置多语言</p><h2 id="解决方案" tabindex="-1">解决方案 <a class="header-anchor" href="#解决方案" aria-label="Permalink to &quot;解决方案&quot;">​</a></h2><h3 id="方案1" tabindex="-1">方案1 <a class="header-anchor" href="#方案1" aria-label="Permalink to &quot;方案1&quot;">​</a></h3><p>针对全局设置多语言，<a href="https://element-plus.org/zh-CN/component/config-provider.html" target="_blank" rel="noreferrer">el-config-provider</a>还提供了对按钮和消息的相关设置</p><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">import zhCn from &quot;element-plus/lib/locale/lang/zh-cn&quot;</span></span>
