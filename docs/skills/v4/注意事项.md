...
## 案例效果
![案例效果](http://www.e1024.top/drawing-bed/20241226/0.png)
...
![自定义组件](http://www.e1024.top/drawing-bed/20241226/2.png)

### 组件重写
> 组件重写现在支持自定义组件重写以及原子组件的重写，重写完成后将组件注册到对应的Code上即可。

目录结构如下：
![自定义组件](http://www.e1024.top/drawing-bed/20241226/3.png)
