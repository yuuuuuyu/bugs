import{_ as s,c as a,o as n,Q as p}from"./chunks/framework.4df21498.js";const h=JSON.parse('{"title":"Pinia 持久化处理","description":"","frontmatter":{},"headers":[],"relativePath":"博客/2023/02Pinia持久化.md","filePath":"博客/2023/02Pinia持久化.md","lastUpdated":1711079124000}'),l={name:"博客/2023/02Pinia持久化.md"},o=p(`<h1 id="pinia-持久化处理" tabindex="-1">Pinia 持久化处理 <a class="header-anchor" href="#pinia-持久化处理" aria-label="Permalink to &quot;Pinia 持久化处理&quot;">​</a></h1><h2 id="场景" tabindex="-1">场景 <a class="header-anchor" href="#场景" aria-label="Permalink to &quot;场景&quot;">​</a></h2><p>在部分场景下，某些数据需要一直保持，不被浏览器刷新所干扰，此时就需要处理pinia的持久化，要解决这个问题非常简单，在状态改变时将其同步到浏览器的存储中，如 cookie、localStorage、sessionStorage 。每次初始化状态时从存储中去获取初始值即可。</p><p>当前从第三方依赖角度实现pinia的持久化<code>pinia-plugin-persistedstate</code></p><h2 id="配置" tabindex="-1">配置 <a class="header-anchor" href="#配置" aria-label="Permalink to &quot;配置&quot;">​</a></h2><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">pnpm add pinia</span><span style="color:#F97583;">-</span><span style="color:#E1E4E8;">plugin</span><span style="color:#F97583;">-</span><span style="color:#E1E4E8;">persistedstate</span></span>
